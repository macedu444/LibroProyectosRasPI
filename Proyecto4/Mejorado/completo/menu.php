...
function showAll($platos, $platosSel, $ingredientes){
  ...
  echo '<tr><td>Miércoles</td><td>'.$platos[$platosSel[4]-1][1].'</td><td>'.$platos[$platosSel[5]-1][1].'</td></tr>';
  ...
  echo '<tr><td>Sábado</td><td>'.$platos[$platosSel[10]-1][1].'</td><td>'.$platos[$platosSel[11]-1][1].'</td></tr>';
...
//Se añade la funcionalidad de validar en función del parámetro FIN, con lo que se discrimina su hemos de pedir
//una nueva predicción o la lista de ingredientes.
